...
<div class="container-fluid">
    <h1>Log in</h1>
    <form id="logForm" action="api-login.php" method="POST">
        <p>
            <label for="logEmail">Email</label>
            <input id="logEmail" name="regEmail" type="email" required>
        </p>
        <p>
            <label for="logPassword">Password</label>
            <input id="logPassword" name="regPassword" type="password" minlength="4" maxlength="30" required>
        </p>
        <p>
...
<div class="container-fluid">
    ...
    <form id="regForm" action="api-register.php" method="POST">
        ...
        <p>
            <label for="regPhone">Telephone</label>
